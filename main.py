...
if __name__ == "__main__":
    ...
    async def superadmin_help(message: types.Message):
        ...
        help_text = (
            ...
            "📤 <b>/say</b> - Send a message to a specific chat\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "<b>Syntax:</b> <code>/say &lt;target&gt; &lt;message&gt;</code>\n\n"
            "<b>Parameters:</b>\n"
            "  • <code>&lt;target&gt;</code> - Chat identifier (required)\n"
            "    - Numeric chat ID: <code>-1001234567890</code>\n"
            "    - With thread/topic: <code>-1001234567890:123</code>\n"
            "    - Public username: <code>@groupname</code>\n"
            "    - Chat link: <code>t.me/chatname</code>\n"
            "    - Topic link: <code>t.me/chatname/456</code> (456 = topic ID)\n"
            "  • <code>&lt;message&gt;</code> - Text to send (required)\n"
            "    - Supports HTML formatting\n"
            "    - Can be multiline\n\n"
            "<b>Examples:</b>\n"
            "  <code>/say -1001234567890 Hello everyone!</code>\n"
            "  <code>/say -1001234567890:123 Hello to topic 123!</code>\n"
            "  <code>/say @mychannel &lt;b&gt;Important&lt;/b&gt; announcement</code>\n"
            "  <code>/say t.me/mygroup Hello from the link!</code>\n"
            "  <code>/say t.me/mygroup/456 Hello to topic 456!</code>\n\n"
            
            "↩️ <b>/reply</b> - Reply to a specific message in a chat\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "<b>Syntax:</b> <code>/reply &lt;message_link&gt; &lt;reply_text&gt;</code>\n\n"
            "<b>Parameters:</b>\n"
            "  • <code>&lt;message_link&gt;</code> - Telegram message link (required)\n"
            "    - Format: <code>https://t.me/chat/message_id</code>\n"
            "    - Format: <code>https://t.me/c/chat_id/message_id</code>\n"
            "  • <code>&lt;reply_text&gt;</code> - Your reply text (required)\n"
            "    - Supports HTML formatting\n\n"
            "<b>Examples:</b>\n"
            ...
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "<b>Syntax:</b>\n"
            "  <code>/broadcast &lt;message&gt;</code> - Send to ALL monitored chats\n"
            "  <code>/broadcast -list &lt;chats&gt; &lt;message&gt;</code> - Send to specific chats\n\n"
            "<b>Parameters:</b>\n"
            "  • <code>&lt;message&gt;</code> - Text to broadcast (required)\n"
            "    - Supports HTML formatting\n"
            "    - Can be multiline\n"
            "  • <code>-list &lt;chats&gt;</code> - Optional flag to specify targets\n"
            "    - Comma-separated chat IDs or usernames\n"
            "    - No spaces between items\n\n"
            "<b>Examples:</b>\n"
            "  <code>/broadcast Hello to all monitored chats!</code>\n"
            "  <code>/broadcast -list -1001234,-1005678 Hello specific chats!</code>\n"
            "  <code>/broadcast -list @chat1,@chat2 Message to these groups</code>\n\n"
            "<b>⚠️ Security:</b> Two-step confirmation required\n"
            "  1️⃣ Click the <b>✅ Proceed</b> button to confirm target count\n"
            "  2️⃣ Type exactly <code>CONFIRM BROADCAST</code> to execute\n"
            "  ⏱️ Confirmation expires after 5 minutes\n\n"
            
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "💬 <b>Replying to User Direct Messages</b>\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            ...
            "💡 <b>Tips &amp; Notes</b>\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "• <b>HTML tags supported:</b> &lt;b&gt;, &lt;i&gt;, &lt;u&gt;, &lt;s&gt;, &lt;code&gt;, &lt;pre&gt;, &lt;a href=\"\"&gt;\n"
